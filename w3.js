...
function exercise4(varA, varB) {
  ...
  // Write your code for the exercise below here:
  // --------------------------------------------
  if (typeof varA == typeof varB) && (varA == varB){
  let answer4 = "varA and varB are equal";
  }else{
  let answer4 = "varA and varB differ";
  }
  // --------------------------------------------
  // And above here
  // --------------------------------------------
...
// If the numbers are the same but the types are differnt, boolean values would not work if they were not both true or not both false.
...
// not too difficult, used google to look up typeof and how to format and if/else
