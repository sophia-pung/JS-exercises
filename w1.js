...
// num2 but not num1?
/*
The difference between num1 and num2 is that:
num1 needs to be a value greater than 1 and less than 10. The value can be 2-9.
num2 can be a value that is equal to 1 and less than or equal to 10.
*/
...
const myAnswerForExercise11 = "num";
...
const myAnswerForExercise16 = "undefined"; //can't multiply string and constant
...
// I think the exercises were simple but some of them were worded weirdly.
